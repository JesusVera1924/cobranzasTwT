 ...
 */
public class NotasCredito implements Parcelable {
    ...
    public NotasCredito(String cod_emp, String cod_mov, String cod_pto, String cod_ref, String cod_ven, int dias_pendiente, Date fec_emi, Date fec_ven,
                        String num_mov, String num_rel, double sdo_mov, double val_mov, double iva, double base, String sts_mov, String cod_bco, boolean sel, double abono){
