...
public class RowFacturaNC implements Parcelable {
    ...
    public RowFacturaNC(String cod_emp, String cod_mov, String cod_pto, String cod_ref, String cod_vin, String cod_ven, String vendedor, int dias_pendiente, String fec_emis, String fec_venc,
    ...
    public static final Creator<RowFacturaNC> CREATOR = new Creator<RowFacturaNC>()
    {
        public RowFacturaNC createFromParcel(Parcel in)
        {
            return new RowFacturaNC(in);
        }
        public RowFacturaNC[] newArray(int size)
        {
            return new RowFacturaNC[size];
        }
    };
